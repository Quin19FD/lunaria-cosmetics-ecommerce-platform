...
export const COLLECTIONS_MOCK: Collection[] = [
  {
    ...
    highlightWord: "Bloom.",
    summary:
      "Sự tôn vinh của sự hồi sinh. Được truyền cảm hứng từ các loài thực vật có hoa và sắc tố phản chiếu ánh sáng mô phỏng nét chạm đầu tiên của bình minh trên những hạt sương sớm.",
    description: [
    ...
    heroImage:
      "https://images.unsplash.com/photo-1490750967868-88aa4f44baee?w=1400&h=700&fit=crop&q=80",
    cardImage:
  ...
  },
  {
    ...
    summary:
      "Sâu lắng, bí ẩn và mạnh mẽ. Khám phá bảng màu của mận đậm và than nhung được thiết kế cho những giờ sau khi hoàng hôn buông xuống.",
    description: [
    ...
    heroImage:
      "https://images.unsplash.com/photo-1495638488670-437f770ef8c5?w=1400&h=700&fit=crop&q=80",
    cardImage:
      "https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&h=700&fit=crop&q=80",
    productSlugs: [
      "mascara-lam-day-mi",
      "son-li-hong-dat",
      "dau-xa-phuc-hoi",
  ...
  },
  {
    ...
    summary:
      "Tinh tuý của LUNARIA được ghi lại. Một dòng phấn bắt sáng và tinh chất vượt thời gian tạo nên sự rạng rỡ từ bên trong không bao giờ phai nhạt.",
    description: [
    ...
    ctaLabel: "Xem bộ sưu tập",
    heroImage:
      "https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=1400&h=700&fit=crop&q=80",
    cardImage:
      "https://images.unsplash.com/photo-1583209814683-c023dd293cc6?w=600&h=700&fit=crop&q=80",
    productSlugs: [
      "phan-nen-kiem-dau",
      "son-li-hong-dat",
      "serum-vitamin-c",
